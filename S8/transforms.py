...
class Transforms():
    ...
    def albumentations_transforms(self, test=False):
        if test:
            transform = A.Compose([
    ...
    def train_transforms(self):
        return AlbumentationsTransform(self.albumentations_transforms(test=False))
    ...
    def test_transforms(self):
        test_transforms = AlbumentationsTransform(self.albumentations_transforms(test=True))
